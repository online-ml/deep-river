...
from deep_river.regression.zoo import LinearRegressionInitialized, LSTMRegressorInitialized, MultiLayerPerceptronInitialized, AttentionRegressorInitialized
